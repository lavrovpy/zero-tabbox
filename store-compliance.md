...
| **Listing assets** | ⚠️ Incomplete | At least one screenshot (1280×800 or 640×400) is required and the repo has none. Also needed at listing time: detailed description, category, support contact. |
...
4. Produce at least one 1280×800 screenshot for the Chrome listing, plus the
   detailed description, category and support contact. *(Chrome listing)*
5. Decide on `gecko_android`: verify on Firefox for Android, or drop it. *(F3)*
6. Optional: bump to `1.0.0` for a first public listing. *(C4)*

Items 1–4 are submission artifacts. Item 5 is the only one that touches the
